...
const resolveTextColor = (
  ...
  return themeColorToCss(
    (hasExplicitThemeColor(color) ? color : getReadableForegroundColor(surfaceColor))
      .selectedColor,
  );
};
...
export const YextBarSocialDiningEventSection: YextComponentConfig<YextBarSocialDiningEventSectionProps> =
  {
    ...
    defaultProps: {
      ...
      overlayColor: {
        selectedColor:
          "[linear-gradient(90deg, rgba(23, 18, 25, 0.72), rgba(23, 18, 25, 0.1))]",
      ...
      heading: {
        text: {
          field: "",
          constantValue: {
            defaultValue: "Host Your Next Group Event at Redwood Burger Co.",
