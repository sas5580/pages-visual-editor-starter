      ...
      >
        ...
        >
          <div
            ...
            style={{
              gridTemplateColumns: hasHeroImage
                ? undefined
                : "minmax(0, 1fr)",
        ...
        text: {
          ...
          constantValue: {
            defaultValue: getDefaultRTF(
              "An upscale burger restaurant in Austin, Texas offering dine-in, takeout, delivery, and curbside pickup options. The location serves lunch, dinner, and brunch, with happy hour available on weekdays.",
            ),
            hasLocalizedValue: "true",
          },
